...
public:
    ...
    ZLineEdit(QWidget*, char const*, ZSkinService::WidgetClsID = ZSkinService::clsZLineEdit);
    ZLineEdit(QString const&, QWidget*, char const*, ZSkinService::WidgetClsID = ZSkinService::clsZLineEdit);
    ~ZLineEdit();
