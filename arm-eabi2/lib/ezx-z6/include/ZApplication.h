...
{ 
	Q_OBJECT
	unsigned int data[26 - sizeof(QApplication)/4];
...
public slots:
        virtual int slotShutdown();
        virtual int slotQuickQuit();
        virtual int slotUsbStorageInOut(bool);
        virtual int slotClickAppIcon();
        virtual int slotRaise();
