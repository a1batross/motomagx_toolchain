...
public:
    ...
    ZPressButton(QPixmap const&, QString const&, QWidget*, char const*, ZSkinService::WidgetClsID = ZSkinService::clsZPressButton);
    ZPressButton(QString const&, QWidget*, char const*, ZSkinService::WidgetClsID = ZSkinService::clsZPressButton);
    ZPressButton(QWidget*, char const*, ZSkinService::WidgetClsID = ZSkinService::clsZPressButton);
	~ZPressButton();
